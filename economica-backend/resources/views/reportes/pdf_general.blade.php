...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-section h1 { color: #5B80B0; font-size: 28px; font-weight: 800; letter-spacing: -0.5px; }
        ...
        .badge { background-color: rgba(91, 128, 176, 0.10); color: #5B80B0; padding: 3px 10px; border-radius: 12px; font-size: 11px; font-weight: 700; text-transform: uppercase; }
...
<body>
    ...
    @if($tipo === 'general')
        ...
        <h3 style="font-size: 14px; font-weight: 700; margin-bottom: 8px; color: #5B80B0; text-transform: uppercase;">Resumen de Actividad Comercial</h3>
