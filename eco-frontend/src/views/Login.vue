<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="bg-white shadow-2xl rounded-3xl overflow-hidden w-full max-w-5xl grid grid-cols-2">
      ...
      <div class="bg-[#47B5AC] text-white flex flex-col items-center justify-center p-12">
        <img
          src="/logo.jpeg"
          alt="Logo"
      ...
      <div class="p-12 flex flex-col justify-center">
        ...
        <div class="mb-5">
          ...
          <input v-model="name" type="text" placeholder="Ingrese usuario" class="w-full px-4 py-3 border
           border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#47B5AC]" />
        </div>
        ...
        <div class="mb-6">
         ...
         <input
          ...
          class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#47B5AC]"
        />
        </div>
        ...
        <button
          @click="handleLogin"
          :disabled="loading"
          class="w-full bg-[#47B5AC] hover:bg-[#47B5AC] text-white py-3 rounded-xl font-semibold shadow-md transition disabled:opacity-50"
        >
